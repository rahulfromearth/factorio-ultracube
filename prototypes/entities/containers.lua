...
circuit_connector_definitions["cube-big-container"] = circuit_connector_definitions.create_vector(universal_connector_template, {
  {
    variation = 26,
...
data:extend({
  {
    ...
    picture = {
      filename = "__krastorio2-assets-ultracube__/buildings/storehouse/storehouse.png",
      priority = "extra-high",
      width = 340,
      height = 340,
      scale = 0.25,
  ...
  },
  {
    ...
    opened_duration = logistic_chest_opened_duration,
    picture = {
      filename = "__krastorio2-assets-ultracube__/buildings/warehouse/warehouse.png",
      priority = "extra-high",
      width = 512,
      height = 512,
      scale = 0.25,
    ...
    water_reflection = {
      pictures = {
        filename = "__krastorio2-assets-ultracube__/buildings/warehouse/warehouse-reflection.png",
        priority = "extra-high",
        width = 60,
        height = 50,
...

  {
    ...
    pictures = {
      picture = {
        sheets = {
          {
            filename = "__krastorio2-assets-ultracube__/buildings/big-storage-tank/big-storage-tank.png",
            priority = "extra-high",
            frames = 1,
            scale = 0.5,
            width = 256,
          ...
          {
            filename = "__krastorio2-assets-ultracube__/buildings/big-storage-tank/big-storage-tank-sh.png",
            priority = "extra-high",
            frames = 1,
            scale = 0.5,
            width = 256,
    ...
    water_reflection = {
      pictures = {
        filename = "__krastorio2-assets-ultracube__/buildings/big-storage-tank/big-storage-tank-reflection.png",
        priority = "extra-high",
        width = 40,
        height = 35,
  ...
  },
  {
    ...
    pictures = {
      picture = {
        sheets = {
          {
            filename = "__krastorio2-assets-ultracube__/buildings/huge-storage-tank/huge-storage-tank.png",
            priority = "extra-high",
            frames = 1,
            scale = 0.5,
            width = 426,
          ...
          {
            filename = "__krastorio2-assets-ultracube__/buildings/huge-storage-tank/huge-storage-tank-sh.png",
            priority = "extra-high",
            frames = 1,
            scale = 0.5,
            width = 426,
    ...
    water_reflection = {
      pictures = {
        filename = "__krastorio2-assets-ultracube__/buildings/huge-storage-tank/huge-storage-tank-reflection.png",
        priority = "extra-high",
        width = 52,
        height = 48,
        shift = util.by_pixel(0, 40),
