...
data:extend({
...

  {
    ...
    energy_required = 2,
    categories = {"cube-stygian-energy-lab"},
  ...
  },
  {
    ...
    energy_required = 2,
    main_product = "",
    categories = {"cube-annihilation-chamber"},
    subgroup = "cube-energy-fluids",
