data:extend({
...

  {
    ...
    main_product = "",
    energy_required = 4,
    categories = {"cube-ultradense-furnace"},
  ...
  },
  {
    ...
    ingredients = {
      {type = "fluid", name = "water", amount = 200, ignored_by_stats = 200},
      {type = "item", name = "cube-sand", amount = 4},
    },
    results = {{type = "fluid", name = "water", amount = 240, ignored_by_stats = 200, show_details_in_recipe_tooltip = false}},
    energy_required = 4,
  ...
  },
  {
    ...
    results = {
      ...
      {type = "fluid", name = "water", amount = 300, show_details_in_recipe_tooltip = false},
    },
    energy_required = 4,
    categories = {"cube-chemical-plant"},
    subgroup = "cube-experimental",
  ...
  },
  {
    ...
    results = {
      {type = "item", name = "cube-uranium-234", amount = 3, ignored_by_stats = 1, ignored_by_productivity = 1, show_details_in_recipe_tooltip = false},
      {type = "item", name = "uranium-235", amount = 41, ignored_by_stats = 40, ignored_by_productivity = 40, show_details_in_recipe_tooltip = false},
      {type = "item", name = "uranium-238", amount = 2, ignored_by_stats = 2, ignored_by_productivity = 2, show_details_in_recipe_tooltip = false},
    },
    energy_required = 60,
    categories = {"centrifuging"},
    subgroup = "cube-uranium-processing",
  ...
  },
  {
    ...
    results = {
      {type = "item", name = "cube-uranium-234", amount_min = 25, amount_max = 300, ignored_by_stats = 200, show_details_in_recipe_tooltip = false},
      {type = "item", name = "uranium-238", amount_min = 125, amount_max = 300, ignored_by_stats = 200, show_details_in_recipe_tooltip = false},
